        ...
        if(this.validatedAccess == true) {
          ...
          .subscribe(
            data=> {
              ...
              for(var whichConn = 0; whichConn < this.network.length; whichConn++) {
                if(this.network[whichConn].photoBean.userId == -1) {
                  this.network[whichConn]['photoExists'] = false;
                }
                else {
                  this.network[whichConn]['photoExists'] = true;
                }
              }
          ...
          .subscribe(
            data => {
              ...
              for(var i = 0; i < this.articles.length; i++) {
                for(var j = 0; j < this.articles[i].comments.length; j++) {
                  if(this.articles[i].comments[j].photoBean.userId == -1) {
                    this.articles[i].comments[j]['photoExists'] = false;
                  }
                  else {
                    this.articles[i].comments[j]['photoExists'] = true;
                  }
                }
              }
